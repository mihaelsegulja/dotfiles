# Generated by Powerlevel10k configuration wizard on 2025-05-02 at 14:43 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 52069.
# Wizard options: nerdfont-v3 + powerline, large icons, unicode, lean_8colors, 2 lines,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=166
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=1
  # Lambda symbol for all modes.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_{VIINS,VICMD,VIVIS,VIOWR}_CONTENT_EXPANSION='λ'
